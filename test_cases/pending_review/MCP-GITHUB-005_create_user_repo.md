---
scenario_id: MCP-GITHUB-005
scenario_name: Create GitHub User Repository
...
`mcp-github-create-user-repo`

### Business Objective

Verify that an authorised caller can create a repository for the authenticated GitHub user account through the GitHub MCP tool.
...
The tool successfully performs the primary positive path to create a repository, and the repository exists under the authenticated user with the submitted settings.
