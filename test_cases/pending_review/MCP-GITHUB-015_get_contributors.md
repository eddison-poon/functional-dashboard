---
scenario_id: MCP-GITHUB-015
scenario_name: Retrieve GitHub Repository Contributors
...
`mcp-github-get-contributors`

### Business Objective

Verify that an authorised caller can retrieve contributor information for an existing repository with a known contributor through the GitHub MCP tool.
...
The tool successfully performs the primary positive path to retrieve contributor information, and the expected contributor is included.
