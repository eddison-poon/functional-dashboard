---
scenario_id: MCP-GITHUB-029
scenario_name: List GitHub Organization Repositories
...
`mcp-github-list-org-repos`

### Business Objective

Verify that an authorised caller can list repositories for an accessible organization containing a known repository through the GitHub MCP tool.
